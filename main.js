        ...
        <div>
          <form id="contact-form" style="background:var(--light-bg); padding:2rem; border-radius:16px;">
            ...
            <div style="margin-bottom:1rem;">
              ...
              <input type="email" id="email" name="email" style="width:100%; padding:0.75rem; border:1px solid var(--softline); border-radius:8px;" placeholder="you@example.com" required>
            </div>
            
            <div style="margin-bottom:1rem;">
              <label for="phone" style="display:block; margin-bottom:0.5rem; color:var(--muted);">Phone (Optional)</label>
              <input type="tel" id="phone" name="phone" style="width:100%; padding:0.75rem; border:1px solid var(--softline); border-radius:8px;" placeholder="+971 XX XXX XXXX">
            </div>
